	...
	uchar status;
		...
		if (status == MI_OK)
		{
			 ...
			 Serial.print(serNum[4],BIN);
                         Serial.print(" , ");
			 Serial.print(serNum[5],BIN);
                         Serial.print(" , ");
			 Serial.print(serNum[6],BIN);
                         Serial.print(" , ");
			 Serial.print(serNum[7],BIN);
                         Serial.print(" , ");
			 Serial.print(serNum[8],BIN);
                         Serial.println(" ");
                        ...
                        } else if(serNum[0] == 171) {
                          Serial.println("Hello One Mans Atnhology");
                        }
                        delay(1000);
		}
                //Serial.println(" ");
...
void MFRC522_Init(void)
{
	...
	Write_MFRC522(RFCfgReg, (0x07<<4));   		//RxGain = 48dB
